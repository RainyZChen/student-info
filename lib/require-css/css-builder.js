define(['require', '../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../../normalize'], function(req, normalize) {
  ...
  var writeCSSDefinition = "define('@writecss', function() {return function writeCss(c) {var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/styles';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));};});";
  ...
  cssAPI.load = function(name, req, load, _config) {
    ...
    var fileUrl = req.toUrl(name + '.styles');
    if (isWindows)
  ...
  cssAPI.normalize = function(name, normalize) {
    if (name.substr(name.length - 4, 4) == '.styles')
  ...
  cssAPI.onLayerEnd = function(write, data) {
    ...
    if (config.separateCSS) {
      var outPath = data.path.replace(/(\.js)?$/, '.styles');
      ...
      for (var i = 0; i < styles.length; i++) {
        if (styles[i] == '')
          return;
        write(
          "(function(c){var d=document,a='appendChild',i='styleSheet',s=d.createElement('style');s.type='text/styles';d.getElementsByTagName('head')[0][a](s);s[i]?s[i].cssText=c:s[a](d.createTextNode(c));})\n"
